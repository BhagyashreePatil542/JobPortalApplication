...
public class MyEmailSender {
	...
	public void sendOtp(JobSeeker jobSeeker) {
		...
		try {
			helper.setFrom("bhagyapatil970@gmail.com", "Job-Portal Application");
			...
			System.out.println("The Otp is : "+jobSeeker.getOtp());
		}
	...
	public void sendOtp(Recruiter recruiter) {
		...
		try {
			...
			System.out.println("The Otp is : "+recruiter.getOtp());
		}
	}
